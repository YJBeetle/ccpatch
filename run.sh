...
function Ps()
{
    run \
        ...
        "\x55\x48\x89\xE5\x53\x50\x48\x89\xFB\x48\x8D\x35\x99\x7E\x91\x01" \
        "\x33\xC0\xC3\xE5\x53\x50\x48\x89\xFB\x48\x8D\x35\x99\x7E\x91\x01"
}
...
function Ai()
{
    run \
        ...
        "\x55\x48\x89\xE5\x53\x50\x48\x89\xFB\x48\x8D\x35\xB1\x6C\x02\x01" \
        "\x33\xC0\xC3\xE5\x53\x50\x48\x89\xFB\x48\x8D\x35\xB1\x6C\x02\x01"
}
